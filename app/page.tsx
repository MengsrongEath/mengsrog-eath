  ...
  const projects = [
    {
      ...
      github: "https://github.com/username/furniture-website",
    },
    {
      id: 2,
      title: "Factory ",
      ...
      github: "https://github.com/username/interior-platform",
    },
    {
      id: 3,
      ...
      github: "https://github.com/username/ecommerce-furniture",
    },
    {
      id: 4,
      ...
      github: "https://github.com/username/design-portfolio",
    },
    {
      id: 5,
      title: "Modern Furniture Store",
      image: "/placeholder.svg?height=300&width=400",
      demo: "https://modern-store-demo.com",
      github: "https://github.com/username/modern-furniture",
    },
  ];
      ...
      <main className={`${isDark ? "bg-gray-900" : "bg-white"}`}>
        ...
        >
          ...
          >
            ...
            >
              {[
                { icon: Mail, text: "eathmengsrong@gmail.com" },
                { icon: Phone, text: "+855 16 455061" },
                { icon: MapPin, text: "Telegram: t.me/eathm" },
                { icon: Linkedin, text: "eathmengsrong@gmail.com" },
              ].map((item, index) => (
                <motion.div
                  key={index}
                  variants={staggerItem}
        ...
        <section id="projects" className="min-h-screen px-8 py-16">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.2 }}
              variants={staggerContainer}
              key={skillsStartIndex} // Add key to trigger re-animation
            >
              {getCurrentSkills().map((skill, index) => (
                <motion.div
                  key={`${skill.name}-${skillsStartIndex}`} // Unique key for each skill
